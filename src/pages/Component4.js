  ...
  return (
    <>
      <div className={styles.div}>
        ...
        <img className={styles.groupIcon} alt="" src="../group-349491.svg" />
        ...
        <img className={styles.groupIcon3} alt="" src="../group-32.svg" />
        <img className={styles.groupIcon4} alt="" src="../group-34956.svg" />
        <div className={styles.rectangleDiv10} />
        <div className={styles.rectangleDiv11} />
        <img className={styles.groupIcon5} alt="" src="../group-261.svg" />
        ...
        <div className={styles.groupDiv4} onClick={openAddTask}>
        ...
        <img className={styles.groupIcon8} alt="" src="../group-32.svg" />
        <img className={styles.groupIcon9} alt="" src="../group-349331.svg" />
